...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/28 15:51:10 by frushiti          #+#    #+#             */
/*   Updated: 2024/06/28 15:51:12 by frushiti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_init_dir(t_recup *recup)
{
	...
	else if (recup->depart == 'S')
	{
		recup->ray.dirx = 1;
		recup->ray.plany = -0.66;
	}
	else if (recup->depart == 'E')
	{
		recup->ray.diry = 1;
		recup->ray.planx = 0.66;
	}
	else if (recup->depart == 'W')
	{
		recup->ray.diry = -1;
		recup->ray.planx = -0.66;
	}
